...
const Main: React.FC = () => {
  ...
  return (
    <div className="main-page-box">
      ...
      <nav className={`mobile-nav ${isNavOpen ? 'open' : ''}`} id="mobile-nav" aria-hidden={!isNavOpen}>
        <button className="mobile-nav-close" onClick={() => setIsNavOpen(false)}>&times;</button>
        <a href="#collection" onClick={() => setIsNavOpen(false)}>컬렉션</a>
        <a href="#lookbook" onClick={() => setIsNavOpen(false)}>룩북</a>
        <a href="#brand" onClick={() => setIsNavOpen(false)}>브랜드</a>
        <a href="#contact" onClick={() => setIsNavOpen(false)}>문의</a>
      </nav>
      ...
      <header role="banner" id="header" className={isScrolled ? 'scrolled' : ''}>
        <nav className="container header-nav" aria-label="메인 내비게이션">
          ...
          <div className="nav-right" id="nav-right">
            ...
            <a href="#collection" className="btn-header desktop-only" style={{ marginLeft: '0.5rem' }}>쇼핑하기</a>
            <button
              className="hamburger"
              id="hamburger"
      ...
      <main id="main">
        <section className="hero" aria-labelledby="hero-heading">
          ...
          <div className="hero-content">
            ...
            <h1 id="hero-heading" className="hero-title fade-in const-in-delay-1">
              남성의 선,<br /><em>La Ligne</em>
            </h1>
            <p className="hero-subtitle fade-in fade-in-delay-2">
              라 린느 옴므는 프랑스어로 '남성의 선'을 의미합니다.<br />
              깔끔한 실루엣과 미니멀한 디자인으로 현대 남성의 감각을 완성합니다.
            </p>
            <div className="hero-cta-group fade-in fade-in-delay-3">
              <a href="#collection" className="btn-primary">컬렉션 보기</a>
              <a href="#brand" className="btn-secondary">브랜드 스토리</a>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="brand-intro-inner">
              ...
              <p className="section-body fade-in fade-in-delay-2">
                '라 린느 옴므(La Ligne Homme)'는 세련되고 감각적인 무드를 지향하는 남성 컨템포러리 패션 브랜드입니다.<br />
                프랑스어로 '남성의 선'이라는 의미를 담고 있는 만큼, 깔끔한 실루엣과 미니멀한 디자인이 특징입니다.<br /><br />
                과하지 않고, 부족하지도 않게. 정제된 선 하나에 담긴 감각이 현대 남성의 일상을 더욱 특별하게 만들어 드립니다.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="collection-header">
              <div>
                ...
                <h2 id="collection-heading" className="section-title fade-in fade-in-delay-1">New Arrivals</h2>
              </div>
              <a href="#collection" className="btn-secondary fade-in">전체 보기</a>
            </div>
            ...
            <div className="collection-grid" role="list">
              {products.length > 0 ? (
                products.map((product, idx) => (
                  <article key={product.id} className={`product-card fade-in fade-in-delay-${idx % 3}`} role="listitem">
        ...
        <section className="editorial" aria-labelledby="editorial-heading">
          <div className="editorial-visual" aria-hidden="true"><div className="editorial-bg"></div></div>
          <div className="editorial-content">
            ...
            <p className="editorial-body fade-in fade-in-delay-2">과잉을 걷어낸 자리에 남는 것, 그것이 라 린느 옴므가 추구하는 스타일입니다. 불필요한 장식을 줄이고 소재 본연의 질감과 실루엣으로 완성한 옷은 시간이 지나도 빛을 잃지 않습니다.</p>
            <a href="#collection" className="btn-primary fade-in fade-in-delay-3">컬렉션 탐색하기</a>
          </div>
        </section>
        ...
        <section className="values" aria-labelledby="values-heading">
          <div className="container">
            ...
            <h2 id="values-heading" className="section-title fade-in fade-in-delay-1">브랜드가 지키는 것들</h2>
            <div className="values-grid">
              <div className="value-item fade-in">
                <p className="value-number" aria-hidden="true">01</p><h3 className="value-title">Silhouette First</h3>
                <p className="value-body">실루엣이 먼저입니다. 몸의 선을 살리는 패턴 작업에서 라 린느 옴므의 모든 디자인이 시작됩니다. 유행에 흔들리지 않는 클래식한 라인을 고집합니다.</p>
              </div>
              <div className="value-item fade-in fade-in-delay-1">
                <p className="value-number" aria-hidden="true">02</p><h3 className="value-title">Material Integrity</h3>
                <p className="value-body">소재의 진정성을 믿습니다. 이탈리아 울, 퓨어 리넨, 메리노 울 — 엄선된 원단만이 라 린느 옴므의 이름을 달 수 있습니다.</p>
              </div>
              <div className="value-item fade-in fade-in-delay-2">
                <p className="value-number" aria-hidden="true">03</p><h3 className="value-title">Timeless Over Trendy</h3>
                <p className="value-body">한 시즌이 아닌 10년을 입을 수 있는 옷을 만듭니다. 트렌드는 참고하되, 시대를 초월하는 클래식함이 우리가 도달하려는 목표입니다.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="lookbook" id="lookbook" aria-labelledby="lookbook-heading">
          <div className="container">
            ...
            <h2 id="lookbook-heading" className="section-title fade-in fade-in-delay-1">The Look</h2>
          </div>
          <div className="lookbook-strip" role="list" aria-label="룩북 이미지 모음">
            <div className="look-item fade-in" role="listitem" tabIndex={0} aria-label="Look 01"><img className="look-inner" src="images/look-01.jpg" alt="Look 01" /></div>
            <div className="look-item fade-in fade-in-delay-1" role="listitem" tabIndex={0} aria-label="Look 02"><img className="look-inner" src="images/look-02.jpg" alt="Look 02" /></div>
            <div className="look-item fade-in fade-in-delay-2" role="listitem" tabIndex={0} aria-label="Look 03"><img className="look-inner" src="images/look-03.jpg" alt="Look 03" /></div>
            <div className="look-item fade-in" role="listitem" tabIndex={0} aria-label="Look 04"><img className="look-inner" src="images/look-04.jpg" alt="Look 04" /></div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="faq-inner">
              ...
              <div className="faq-list fade-in fade-in-delay-2">
                <details><summary>배송은 얼마나 걸리나요?</summary><p>국내 배송은 결제 확인 후 영업일 기준 2~3일 이내 출고됩니다. 제주 및 도서산간 지역은 추가 2일이 소요될 수 있습니다. 주문 후 발송 알림 문자를 통해 배송 현황을 확인하실 수 있습니다.</p></details>
                <details><summary>교환 및 반품이 가능한가요?</summary><p>상품 수령 후 7일 이내 교환 및 반품이 가능합니다. 단, 착용 흔적이 있거나 태그가 제거된 경우에는 교환·반품이 제한될 수 있습니다. 자세한 사항은 고객센터로 문의해 주시기 바랍니다.</p></details>
                <details><summary>사이즈 선택이 어렵습니다. 어떻게 해야 할까요?</summary><p>각 상품 상세 페이지에 정확한 실측 사이즈 가이드가 제공됩니다. 라 린느 옴므의 제품은 슬림 실루엣을 기본으로 하므로, 평소보다 한 사이즈 크게 선택하시는 분들도 계십니다. 사이즈 문의는 채팅 상담을 이용해 주세요.</p></details>
                <details><summary>세탁은 어떻게 하는 것이 좋을까요?</summary><p>울 및 리넨 소재는 드라이클리닝을 권장합니다. 코튼 소재는 냉수 손세탁이 가능하며, 탈수 후 그늘에서 평평하게 건조해 주세요. 각 상품의 케어 라벨에 세탁 방법이 상세히 표기되어 있습니다.</p></details>
                <details><summary>해외 배송도 가능한가요?</summary><p>현재는 국내 배송만 운영 중이며, 해외 배송 서비스는 2025년 하반기 오픈 예정입니다. 글로벌 론칭 소식을 가장 먼저 받아보시려면 뉴스레터를 구독해 주세요.</p></details>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="newsletter" aria-labelledby="newsletter-heading">
          <div className="container">
            ...
            <h2 id="newsletter-heading" className="section-title fade-in fade-in-delay-1">새 컬렉션을 가장 먼저<br />만나보세요</h2>
            <p className="newsletter-desc fade-in fade-in-delay-2">신상품, 룩북, 브랜드 이야기를 뉴스레터로 전달합니다. 구독자에게는 첫 구매 시 10% 할인 혜택을 드립니다.</p>
            <form ref={formRef} onSubmit={handleNewsletterSubmit} className="newsletter-form fade-in fade-in-delay-2" noValidate>
              <label htmlFor="email-input" className="visually-hidden">이메일 주소</label>
              <input type="email" id="email-input" name="email" className="newsletter-input" placeholder={newsletterPlaceholder} autoComplete="email" required />
              <button type="submit" className="newsletter-btn">구독하기</button>
            </form>
            <p className="newsletter-notice fade-in">개인정보 처리방침에 동의하며, 언제든지 수신을 거부할 수 있습니다.</p>
          </div>
        </section>
        ...
        <section className="final-cta" id="contact" aria-labelledby="final-cta-heading">
          <div className="container">
            ...
            <div className="final-cta-actions fade-in fade-in-delay-2">
              <a href="#collection" className="btn-primary">쇼핑 시작하기</a>
        ...
        <div className="container">
          <div className="footer-top">
            <div className="footer-brand">
              <a href="/" className="logo">La Ligne Homme<span>라 린느 옴므</span></a>
              <p className="footer-tagline">세련되고 감각적인 무드를 지향하는<br />남성 컨템포러리 패션 브랜드</p>
            </div>
            <div className="footer-col">
              <h4>쇼핑</h4>
              <ul>
                <li><a href="#collection">아우터</a></li>
                <li><a href="#collection">티셔츠 / 셔츠</a></li>
                <li><a href="#collection">가디건 / 니트</a></li>
                <li><a href="#collection">팬츠</a></li>
                <li><a href="#lookbook">룩북</a></li>
              </ul>
            </div>
            <div className="footer-col">
          ...
          <div className="footer-biz">
            ...
            <a href="https://open.kakao.com/o/spCfHpui" target="_blank" rel="noopener noreferrer" className="footer-kakao">카카오 오픈채팅 상담 &rarr;</a>
          </div>

          <div className="footer-bottom">
            <p className="footer-legal">&copy; 2025 La Ligne Homme. All rights reserved.</p>
            <nav className="footer-legal-links" aria-label="법적 링크"><a href="#">개인정보 처리방침</a><a href="#">이용약관</a></nav>
          </div>
        </div>
      </footer>
    </div>
